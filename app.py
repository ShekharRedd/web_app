...
# Configure logging
log_file = "C:/vscode/elasticsearch/data/shake.log"
# 2023-08-23 12:06:32,983 - INFO - 127.0.0.1 - - [23/Aug/2023 12:06:32] "GET /medicine HTTP/1.1" 200 -
# 2023-08-23 12:06:33,012 - INFO - 127.0.0.1 - - [23/Aug/2023 12:06:33] "[36mGET /static/MedicinePage.css HTTP/1.1[0m" 304 -

logging.basicConfig(filename=log_file, level=logging.INFO,format='%(asctime)s  %(levelname)s  %(message)s')


# print(logging.basicConfig(format='%(message)s'))
# D:\Fake_product_Detection_Using_Blockchain_Technology (4)\Code\main.py
@app.route("/")
def home():
    if session.get("user"):
